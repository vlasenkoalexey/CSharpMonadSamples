...
namespace MonadsExtensions
{
    public static class TaskMonadExtensions
    {
        ...
        public static async Task<TNewResult> BindAlt<TResult, TNewResult>(this Task<TResult> task, 
            Func<TResult, Task<TNewResult>> continuation)
        {
            return await continuation(await task);
        }

        public static Task<TNewResult> Bind<TResult, TNewResult>(this Task<TResult> task, 
            Func<TResult, Task<TNewResult>> continuation)
        {
